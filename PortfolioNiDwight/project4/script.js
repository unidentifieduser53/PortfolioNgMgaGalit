// =============================================
//  Portfolio JavaScript — shared by index.html
//  and every project page (project1-4.html).
//  Each feature checks that its element exists,
//  so this file is safe to reuse on any page.
// =============================================
...
// --- 6. Scale Activity Previews to Fit Their Cards ---
function scalePreviews() {
    document.querySelectorAll('.activity-card .preview').forEach(preview => {
        const iframe = preview.querySelector('iframe');
        if (iframe) {
            iframe.style.transform = `scale(${preview.clientWidth / 1280})`;
        }
    });
}
